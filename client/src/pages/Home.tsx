...
import { useProjects, useSkills, useEducation } from "@/hooks/use-portfolio";
...
export default function Home() {
  ...
  return (
    <div className="bg-background min-h-screen selection:bg-primary/30 text-foreground overflow-x-hidden">
      <Navigation />
